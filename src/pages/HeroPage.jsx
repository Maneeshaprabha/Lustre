   ...
   <Navbar />
    <div className="min-h-screen w-full bg-white text-[#1A1A1A] font-sans antialiased overflow-hidden flex items-center">
      ...
      <main className="max-w-[1400px] w-full mx-auto px-6 md:px-12 py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
        ...
        >
          {/* Heading matching the exact line breaks of the image */}
          <motion.h1 
            variants={fadeInUp}
            className="text-[3.5rem] md:text-[4rem] font-bold leading-[1.1] mb-6 text-[#1A1A1A]"
          >
            Shine in Style <br />
            Discover <br />
          ...
          <motion.div variants={fadeInUp} className="flex flex-col items-start gap-12">
            {/* Pill-shaped CTA button replacing the green */}
        ...
        <div className="lg:col-span-4 flex justify-center relative h-[600px] lg:h-[800px] z-0 pointer-events-none">
          {/* Using a placeholder that mimics a transparent cutout model */}
          <img 
            src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1000&auto=format&fit=crop" 
            alt="Lustre Model"
            className="absolute bottom-0 w-auto h-[90%] object-cover object-top mask-image-bottom drop-shadow-2xl grayscale-[20%] contrast-[110%]"
            style={{ WebkitMaskImage: 'linear-gradient(to top, transparent 0%, black 15%)' }}
          />
        </div>

        {/* RIGHT COLUMN: Categories and Product Card */}
        <div className="lg:col-span-4 flex flex-col justify-center gap-8 z-10 pl-0 lg:pl-8">
          ...
          <div className="flex gap-3 justify-start lg:justify-end">
            {['WOMEN', 'MENS', 'KIDS'].map((cat) => (
              <button
                ...
                className={`px-6 py-1.5 text-xs tracking-wider font-bold rounded-full transition-all duration-300
                  ${activeCategory === cat 
                    ? 'bg-[#1A1A1A] text-[#E9E3DB]' 
                    : 'bg-[#C4BEB6]/40 text-[#1A1A1A] hover:bg-[#C4BEB6]/70'}`}
              >
                {cat}
              </button>
            ))}
          ...
          {/* Product Card matching the image layout */}
          {/* Using Muted Sand (#C4BEB6) for the outer card background */}
          <div className="bg-[#C4BEB6]/30 p-4 rounded-[2rem] flex gap-5 relative group w-full max-w-[420px] ml-auto shadow-sm backdrop-blur-sm">
            ...
            <div className="flex flex-col justify-center pr-4">
              ...
              <p className="text-[9px] text-[#1A1A1A]/50 font-medium leading-tight">
                Lorem ipsum dolor sit amet,consectetur, ipsum dolor sit amet,dolor sit amet.
              </p>
            </div>
...
export default LustreHeroMatched;