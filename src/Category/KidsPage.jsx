...
const KidsPage = () => {
  ...
  const products = [
    { id: 1, name: "Mini Classic Trench", price: "120.00", image: "https://images.unsplash.com/photo-1519238396246-be760086221c?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 2, name: "Organic Cotton Overalls", price: "65.00", image: "https://images.unsplash.com/photo-1522204523234-8729aa6e3d5f?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 3, name: "Chunky Knit Cardigan", price: "85.00", image: "https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 4, name: "Linen Smock Dress", price: "70.00", image: "https://images.unsplash.com/photo-1601288496920-b6154fe3626a?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 5, name: "Tailored Chino Short", price: "45.00", image: "https://images.unsplash.com/photo-1503919545889-aef636e10ad4?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 6, name: "Breton Stripe Longsleeve", price: "40.00", image: "https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 7, name: "Merino Wool Beanie", price: "35.00", image: "https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 8, name: "Leather Mary Janes", price: "95.00", image: "https://images.unsplash.com/photo-1514090458221-65bb69cf63e6?q=80&w=800&auto=format&fit=crop", isNew: false }
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-white font-sans text-[#1A1A1A] antialiased">
      <header className="pt-24 pb-12 md:pt-32 md:pb-16 px-6 md:px-12 flex flex-col items-center text-center bg-[#FBFBFA]">
        ...
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-5xl md:text-6xl lg:text-7xl font-light tracking-tighter mb-6">Kids</motion.h1>
