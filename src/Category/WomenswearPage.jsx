...
const WomenswearPage = () => {
  ...
  const [activeCategory, setActiveCategory] = useState('All Womenswear');
  ...
  const products = [
    ...
    { id: 3, name: "Ribbed Cashmere Turtleneck", price: "220.00", priceNumber: 220, category: "Knitwear", colorHex: "#E9E3DB", collections: [], image: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 4, name: "Pleated Wide-Leg Trouser", price: "185.00", priceNumber: 185, category: "Bottoms", colorHex: "#1A1A1A", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 5, name: "Oversized Linen Blazer", price: "275.00", priceNumber: 275, category: "Tailoring", colorHex: "#E9E3DB", collections: [], image: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 6, name: "Asymmetric Satin Blouse", price: "150.00", priceNumber: 150, category: "Tops", colorHex: "#FFFFFF", collections: ["Limited Edition"], image: "https://images.unsplash.com/photo-1550614000-4b95d4edaa19?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 7, name: "Tailored Crepe Vest", price: "135.00", priceNumber: 135, category: "Tailoring", colorHex: "#1A1A1A", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 8, name: "Minimalist Leather Tote", price: "390.00", priceNumber: 390, category: "Accessories", colorHex: "#8B4513", collections: ["Best Seller"], image: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?q=80&w=800&auto=format&fit=crop", isNew: false }
  ];

  // --- FILTERING LOGIC ---
  const filteredProducts = products.filter(product => {
    const matchCategory = activeCategory === 'All Womenswear' || product.category === activeCategory;
          ...
          <AnimatePresence>
            {isCategoryOpen && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="flex flex-col overflow-hidden pt-3 gap-2">
                {['All Womenswear', 'Dresses', 'Outerwear', 'Tailoring', 'Knitwear', 'Tops', 'Bottoms', 'Accessories'].map((cat) => (
          ...
          <div className="max-w-[1500px] mx-auto flex flex-col md:flex-row items-end justify-between gap-12">
            <div className="flex flex-col w-full md:w-1/2 lg:w-3/5">
              ...
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter uppercase leading-[0.9] mb-6 text-[#1A1A1A]">
                Effortless <br className="hidden md:block"/> Elegance.
              </motion.h1>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 1, ease: "easeOut" }} className="hidden md:block w-full md:w-1/2 lg:w-2/5 aspect-[4/3] bg-[#E9E3DB] overflow-hidden rounded-none">
              <img src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=1200&auto=format&fit=crop" alt="Luxury Womenswear" className="w-full h-full object-cover object-top grayscale-[15%] hover:scale-105 transition-transform duration-1000" />
            </motion.div>
          </div>
        </section>
          ...
          <div className={`flex flex-col ${showDesktopFilters ? 'lg:col-span-3' : 'w-full'}`}>
            ...
            {sortedProducts.length === 0 ? (
              <div className="w-full flex flex-col items-center justify-center py-20">
                ...
                <button 
                  onClick={() => {
                    setActiveCategory('All Womenswear'); setActiveCollections([]); setActiveColors([]); setActivePrice(null); setSortOption('Featured');
                  }}
