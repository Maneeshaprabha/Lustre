...
const AccessoriesPage = () => {
  ...
  const products = [
    { id: 1, name: "Signature Leather Tote", price: "450.00", image: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 2, name: "Acetate Sunglasses", price: "220.00", image: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 3, name: "Woven Silk Scarf", price: "130.00", image: "https://images.unsplash.com/photo-1584030373081-f37b7bb4fa8e?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 4, name: "Classic Leather Belt", price: "110.00", image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 5, name: "Structured Crossbody", price: "320.00", image: "https://images.unsplash.com/photo-1591561954557-26941169b49e?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 6, name: "Gold Vermeil Cuff", price: "195.00", image: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 7, name: "Cashmere Beanie", price: "95.00", image: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 8, name: "Leather Cardholder", price: "85.00", image: "https://images.unsplash.com/photo-1627123424574-724758594e93?q=80&w=800&auto=format&fit=crop", isNew: false }
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-white font-sans text-[#1A1A1A] antialiased">
      <header className="pt-24 pb-12 md:pt-32 md:pb-16 px-6 md:px-12 flex flex-col items-center text-center bg-[#FBFBFA]">
        ...
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-5xl md:text-6xl lg:text-7xl font-light tracking-tighter mb-6">Accessories</motion.h1>
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3, duration: 0.8 }} className="max-w-xl text-sm md:text-base text-[#1A1A1A]/70 font-medium leading-relaxed">
          The defining details. Handcrafted leather goods, timeless eyewear, and subtle accents to complete the Lustre look.
        </motion.p>
      </header>
