...
const MenswearPage = () => {
  ...
  const [activeCategory, setActiveCategory] = useState('All Menswear');
  ...
  const products = [
    { id: 1, name: "Tailored Wool Overcoat", price: "550.00", priceNumber: 550, category: "Outerwear", colorHex: "#1A1A1A", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=800&auto=format&fit=crop", isNew: true, rating: 5.0, reviews: 45 },
    { id: 2, name: "Merino Wool Turtleneck", price: "180.00", priceNumber: 180, category: "Knitwear", colorHex: "#8B4513", collections: [], image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop", isNew: false, rating: 4.8, reviews: 112 },
    { id: 3, name: "Classic Pleated Trouser", price: "195.00", priceNumber: 195, category: "Bottoms", colorHex: "#1A1A1A", collections: [], image: "https://images.unsplash.com/photo-1594938291221-94f18cbb5660?q=80&w=800&auto=format&fit=crop", isNew: false, rating: 4.7, reviews: 88 },
    { id: 4, name: "Minimalist Leather Jacket", price: "680.00", priceNumber: 680, category: "Outerwear", colorHex: "#1A1A1A", collections: ["New Arrival", "Limited Edition"], image: "https://images.unsplash.com/photo-1520975954732-57dd22299614?q=80&w=800&auto=format&fit=crop", isNew: true, rating: 4.9, reviews: 34 },
    { id: 5, name: "Heavyweight Cotton Tee", price: "85.00", priceNumber: 85, category: "Tops", colorHex: "#FFFFFF", collections: ["Best Seller"], image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop", isNew: false, rating: 4.6, reviews: 215 },
    { id: 6, name: "Double-Breasted Blazer", price: "420.00", priceNumber: 420, category: "Suiting", colorHex: "#4682B4", collections: [], image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=800&auto=format&fit=crop", isNew: false, rating: 4.8, reviews: 56 },
    { id: 7, name: "Relaxed Linen Shirt", price: "125.00", priceNumber: 125, category: "Tops", colorHex: "#E9E3DB", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1596755094514-f87e32f85e2c?q=80&w=800&auto=format&fit=crop", isNew: true, rating: 4.9, reviews: 42 },
    { id: 8, name: "Suede Loafers", price: "290.00", priceNumber: 290, category: "Footwear", colorHex: "#8B4513", collections: ["Best Seller"], image: "https://images.unsplash.com/photo-1614252209825-92576b51c103?q=80&w=800&auto=format&fit=crop", isNew: false, rating: 5.0, reviews: 94 }
  ];

  // --- FILTERING LOGIC ---
  const filteredProducts = products.filter(product => {
    const matchCategory = activeCategory === 'All Menswear' || product.category === activeCategory;
          ...
          <AnimatePresence>
            {isCategoryOpen && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="flex flex-col overflow-hidden pt-3 gap-2">
                {['All Menswear', 'Outerwear', 'Suiting', 'Knitwear', 'Tops', 'Bottoms', 'Footwear'].map((cat) => (
          ...
          <div className="max-w-[1500px] mx-auto flex flex-col md:flex-row items-end justify-between gap-12">
            <div className="flex flex-col w-full md:w-1/2 lg:w-3/5">
              ...
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter uppercase leading-[0.9] mb-6 text-[#1A1A1A]">
                Modern <br className="hidden md:block"/> Tailoring.
              </motion.h1>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 1, ease: "easeOut" }} className="hidden md:block w-full md:w-1/2 lg:w-2/5 aspect-[4/3] bg-[#E9E3DB] overflow-hidden rounded-none">
              <img src="https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=1200&auto=format&fit=crop" alt="Luxury Menswear" className="w-full h-full object-cover grayscale-[15%] hover:scale-105 transition-transform duration-1000" />
            </motion.div>
          </div>
        </section>
          ...
          <div className={`flex flex-col ${showDesktopFilters ? 'lg:col-span-3' : 'w-full'}`}>
            ...
            {sortedProducts.length === 0 ? (
              <div className="w-full flex flex-col items-center justify-center py-20">
                ...
                <button 
                  onClick={() => {
                    setActiveCategory('All Menswear'); setActiveCollections([]); setActiveColors([]); setActivePrice(null); setSortOption('Featured');
                  }}
                        ...
                        {gridView === 'list' && (
                          <>
                            ...
                            <p className="text-sm text-[#1A1A1A]/60 mt-4 max-w-xl leading-relaxed">
                              A meticulously crafted piece designed for the modern man. The {product.name} combines structured tailoring with everyday comfort and premium materials.
                            </p>
                          </>
                        )}
                      </div>
