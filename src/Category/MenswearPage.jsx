...
const MenswearPage = () => {
  ...
  const products = [
    { id: 1, name: "Tailored Wool Overcoat", price: "550.00", priceNumber: 550, category: "Outerwear", colorHex: "#1A1A1A", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1617137968427-85924c800a22?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 2, name: "Merino Wool Turtleneck", price: "180.00", priceNumber: 180, category: "Knitwear", colorHex: "#8B4513", collections: [], image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 3, name: "Classic Pleated Trouser", price: "195.00", priceNumber: 195, category: "Bottoms", colorHex: "#1A1A1A", collections: [], image: "https://images.unsplash.com/photo-1594938291221-94f18cbb5660?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 4, name: "Minimalist Leather Jacket", price: "680.00", priceNumber: 680, category: "Outerwear", colorHex: "#1A1A1A", collections: ["New Arrival", "Limited Edition"], image: "https://images.unsplash.com/photo-1520975954732-57dd22299614?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 5, name: "Heavyweight Cotton Tee", price: "85.00", priceNumber: 85, category: "Tops", colorHex: "#FFFFFF", collections: ["Best Seller"], image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 6, name: "Double-Breasted Blazer", price: "420.00", priceNumber: 420, category: "Suiting", colorHex: "#4682B4", collections: [], image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=800&auto=format&fit=crop", isNew: false },
    { id: 7, name: "Relaxed Linen Shirt", price: "125.00", priceNumber: 125, category: "Tops", colorHex: "#E9E3DB", collections: ["New Arrival"], image: "https://images.unsplash.com/photo-1596755094514-f87e32f85e2c?q=80&w=800&auto=format&fit=crop", isNew: true },
    { id: 8, name: "Suede Loafers", price: "290.00", priceNumber: 290, category: "Footwear", colorHex: "#8B4513", collections: ["Best Seller"], image: "https://images.unsplash.com/photo-1614252209825-92576b51c103?q=80&w=800&auto=format&fit=crop", isNew: false }
  ];
